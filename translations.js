...
const TRANSLATIONS = {
  pt: {
    ...
    rankTabMonth:'📅 Mês atual', rankTabTotal:'👑 Pontuação Geral', rankTabHistory:'🏆 Meses anteriores',
    monthlyRankingTitle:'🏆 Ranking', totalRankingTitle:'👑 Pontuação Geral',
    totalRankingSubtitle:'Pontuação acumulada desde o início',
    badgesTitle:'🎖️ Conquistas', badgesSubtitle:'Desbloqueie todas as medalhas',
    badgesUnlocked:'Conquistas desbloqueadas', badgesLabel:'Conquistas',
    feedTitle:'💬 Feed do Time', chatTitle:'💬 Chat do Time', chatSubtitle:'Grupo Team Lira',
    chatPlaceholder:'Mensagem...', feedTab:'💬 Feed', rankingTab:'🏆 Ranking',
    adminRankTitle:'🏆 Ranking completo',
    streakHeader:'🔥 Sequência — últimos 30 dias',
    calCurrent:'Atual', calBest:'Melhor', calFullDay:'Dia completo', calNoRecord:'Sem registro', days:'dias',
    weightEvolution:'⚖️ Evolução do peso',
    registerBtn:'Registrar', viewAllLevels:'🏆 Ver todos os níveis',
    welcomeBack:'Bem-vindo de volta,', streakDays:'dias de sequência', goTrain:'BORA TREINAR 💪',
    missionBadge:'⚡ Missão do dia', completeMission:'Completar missão',
    todayWorkouts:'📸 Treinos de hoje', todayCheckin:'Check-in de hoje', yourWorkout:'Seu treino',
    daysSeq:'dias seq.', ptsMonth:'pts no mês',
    minAgo:'min atrás', hAgo:'h atrás', dAgo:'d atrás',
    totalPoints:'Total de pontos', trainingsCount:'Treinos realizados',
    currentStreak:'Sequência atual', bestStreak:'Melhor sequência', lastWeight:'Último peso',
    checkinsToday:'Check-ins hoje', initialLevel:'Nível inicial', fromPts:'A partir de',
    loginTabSign:'Entrar', loginTabCreate:'Cadastrar',
  },
    // --- Dias e meses ---
    ...
    // --- UI Strings ---
    btnLoggingIn:'Entrando...', btnLogin:'Entrar', btnCreatingAccount:'Criando conta...', btnCreateAccount:'Criar conta',
    errFillAll:'Preencha todos os campos', errInvalidCode:'Código de convite inválido', errPasswordMin:'Senha: mínimo 6 caracteres',
    rankingLabel:'Top alunos do Team Lira', ptsNeeded:'Faltam', maxLevel:'🏆 Nível máximo!',
    errLoadData:'Erro ao carregar dados.', awaitingApproval:'Aguard. aprovação', workoutsToday:'Treinos hoje',
    statusActive:'Ativo', statusPartial:'Parcial', statusInactive:'Inativo', statusPending:'Pendente', statusBlocked:'Bloqueado',
    rejectStudent:'Rejeitar aluno', blockStudent:'Bloquear aluno', unblockStudent:'Desbloquear aluno',
    block:'Bloquear', unblock:'Desbloquear', confirmBlock:'Bloquear esse aluno?', confirmUnblock:'Desbloquear esse aluno?',
    last7Days:'Últimos 7 dias', activeStudents:'alunos ativos',
    loading2:'Carregando...', errLoad:'Erro ao carregar', errLoadRanking:'Erro ao carregar ranking', errLoadFeed:'Erro ao carregar feed.',
    noActivityYet:'Nenhuma atividade ainda.', noActivityFirst:'Nenhuma atividade ainda.<br>Seja o primeiro! 💪',
    noMsgsYet:'Nenhuma mensagem ainda.', noMsgsFirst:'Nenhuma mensagem ainda. Seja o primeiro! 💬',
    calculating:'Calculando...', weightNoData:'Registre seu peso nos check-ins para ver a evolução aqui!',
    weightSetGoal:'Defina uma meta de peso para acompanhar seu progresso!', monthlyPts:'pts mensais',
    activeToday:'Ativos hoje', filterAll:'Todos', filterActive:'✅ Ativos', filterPending:'⏳ Pendentes',
    filterBlocked:'🚫 Bloqueados', filterInactive:'😴 Sumidos',
    fixHallBtn:'🏆 Corrigir Hall', tiebreakBtn:'🔢 Desempate', fixHallOfFame:'🏆 Corrigir Hall of Fame',
    rankOrder:'🔢 Ordem do Ranking', rankOrderHelp:'Use ▲▼ para reordenar em caso de empate',
    firstPlace:'🥇 1° Lugar', secondPlace:'🥈 2° Lugar', thirdPlace:'🥉 3° Lugar',
  ...
  en: {
    ...
    rankTabMonth:'📅 This Month', rankTabTotal:'👑 All Time', rankTabHistory:'🏆 Past Months',
    monthlyRankingTitle:'🏆 Ranking', totalRankingTitle:'👑 All Time',
    totalRankingSubtitle:'Accumulated score since the beginning',
    badgesTitle:'🎖️ Achievements', badgesSubtitle:'Unlock all medals',
    badgesUnlocked:'Achievements unlocked', badgesLabel:'Achievements',
    feedTitle:'💬 Team Feed', chatTitle:'💬 Team Chat', chatSubtitle:'Team Lira Group',
    chatPlaceholder:'Message...', feedTab:'💬 Feed', rankingTab:'🏆 Ranking',
    adminRankTitle:'🏆 Full Ranking',
    streakHeader:'🔥 Streak — last 30 days',
    calCurrent:'Current', calBest:'Best', calFullDay:'Full day', calNoRecord:'No record', days:'days',
    weightEvolution:'⚖️ Weight Progress',
    registerBtn:'Save', viewAllLevels:'🏆 View all levels',
    welcomeBack:'Welcome back,', streakDays:'day streak', goTrain:"LET'S TRAIN 💪",
    missionBadge:'⚡ Daily Mission', completeMission:'Complete mission',
    todayWorkouts:'📸 Today's workouts', todayCheckin:'Today's check-in', yourWorkout:'Your workout',
    daysSeq:'days seq.', ptsMonth:'pts this month',
    minAgo:'min ago', hAgo:'h ago', dAgo:'d ago',
    totalPoints:'Total points', trainingsCount:'Workouts done',
    currentStreak:'Current streak', bestStreak:'Best streak', lastWeight:'Last weight',
    checkinsToday:'Check-ins today', initialLevel:'Starting level', fromPts:'From',
    loginTabSign:'Sign In', loginTabCreate:'Sign Up',
  },
    // --- Days and months ---
    ...
    // --- UI Strings ---
    btnLoggingIn:'Logging in...', btnLogin:'Log In', btnCreatingAccount:'Creating account...', btnCreateAccount:'Create Account',
    errFillAll:'Please fill in all fields', errInvalidCode:'Invalid invite code', errPasswordMin:'Password: at least 6 characters',
    rankingLabel:'Top students of Team Lira', ptsNeeded:'Need', maxLevel:'🏆 Max level!',
    errLoadData:'Error loading data.', awaitingApproval:'Awaiting approval', workoutsToday:'Workouts today',
    statusActive:'Active', statusPartial:'Partial', statusInactive:'Inactive', statusPending:'Pending', statusBlocked:'Blocked',
    rejectStudent:'Reject student', blockStudent:'Block student', unblockStudent:'Unblock student',
    block:'Block', unblock:'Unblock', confirmBlock:'Block this student?', confirmUnblock:'Unblock this student?',
    last7Days:'Last 7 days', activeStudents:'active students',
    loading2:'Loading...', errLoad:'Error loading', errLoadRanking:'Error loading ranking', errLoadFeed:'Error loading feed.',
    noActivityYet:'No activity yet.', noActivityFirst:'No activity yet.<br>Be the first! 💪',
    noMsgsYet:'No messages yet.', noMsgsFirst:'No messages yet. Be the first! 💬',
    calculating:'Calculating...', weightNoData:'Log your weight in check-ins to see progress here!',
    weightSetGoal:'Set a weight goal to track your progress!', monthlyPts:'monthly pts',
    activeToday:'Active today', filterAll:'All', filterActive:'✅ Active', filterPending:'⏳ Pending',
    filterBlocked:'🚫 Blocked', filterInactive:'😴 Inactive',
    fixHallBtn:'🏆 Fix Hall', tiebreakBtn:'🔢 Tiebreak', fixHallOfFame:'🏆 Fix Hall of Fame',
    rankOrder:'🔢 Ranking Order', rankOrderHelp:'Use ▲▼ to reorder in case of a tie',
    firstPlace:'🥇 1st Place', secondPlace:'🥈 2nd Place', thirdPlace:'🥉 3rd Place',
  ...
  es: {
    ...
    rankTabMonth:'📅 Mes actual', rankTabTotal:'👑 Puntuación Total', rankTabHistory:'🏆 Meses anteriores',
    monthlyRankingTitle:'🏆 Ranking', totalRankingTitle:'👑 Puntuación Total',
    totalRankingSubtitle:'Puntuación acumulada desde el inicio',
    badgesTitle:'🎖️ Logros', badgesSubtitle:'Desbloquea todas las medallas',
    badgesUnlocked:'Logros desbloqueados', badgesLabel:'Logros',
    feedTitle:'💬 Feed del Equipo', chatTitle:'💬 Chat del Equipo', chatSubtitle:'Grupo Team Lira',
    chatPlaceholder:'Mensaje...', feedTab:'💬 Feed', rankingTab:'🏆 Ranking',
    adminRankTitle:'🏆 Ranking completo',
    streakHeader:'🔥 Racha — últimos 30 días',
    calCurrent:'Actual', calBest:'Mejor', calFullDay:'Día completo', calNoRecord:'Sin registro', days:'días',
    weightEvolution:'⚖️ Evolución del peso',
    registerBtn:'Guardar', viewAllLevels:'🏆 Ver todos los niveles',
    welcomeBack:'Bienvenido de vuelta,', streakDays:'días de racha', goTrain:'¡VAMOS A ENTRENAR! 💪',
    missionBadge:'⚡ Misión del día', completeMission:'Completar misión',
    todayWorkouts:'📸 Entrenos de hoy', todayCheckin:'Check-in de hoy', yourWorkout:'Tu entreno',
    daysSeq:'días seq.', ptsMonth:'pts en el mes',
    minAgo:'min atrás', hAgo:'h atrás', dAgo:'d atrás',
    totalPoints:'Total de puntos', trainingsCount:'Entrenos realizados',
    currentStreak:'Racha actual', bestStreak:'Mejor racha', lastWeight:'Último peso',
    checkinsToday:'Check-ins hoy', initialLevel:'Nivel inicial', fromPts:'Desde',
    loginTabSign:'Entrar', loginTabCreate:'Registrarse',
    // --- Días y meses ---
    ...
    // --- UI Strings ---
    btnLoggingIn:'Iniciando sesión...', btnLogin:'Iniciar sesión', btnCreatingAccount:'Creando cuenta...', btnCreateAccount:'Crear cuenta',
    errFillAll:'Por favor, rellena todos los campos', errInvalidCode:'Código de invitación inválido', errPasswordMin:'Contraseña: mínimo 6 caracteres',
    rankingLabel:'Top estudiantes del Team Lira', ptsNeeded:'Faltan', maxLevel:'🏆 ¡Nivel máximo!',
    errLoadData:'Error al cargar datos.', awaitingApproval:'Esperando aprobación', workoutsToday:'Entrenos hoy',
    statusActive:'Activo', statusPartial:'Parcial', statusInactive:'Inactivo', statusPending:'Pendiente', statusBlocked:'Bloqueado',
    rejectStudent:'Rechazar estudiante', blockStudent:'Bloquear estudiante', unblockStudent:'Desbloquear estudiante',
    block:'Bloquear', unblock:'Desbloquear', confirmBlock:'¿Bloquear este estudiante?', confirmUnblock:'¿Desbloquear este estudiante?',
    last7Days:'Últimos 7 días', activeStudents:'estudiantes activos',
    loading2:'Cargando...', errLoad:'Error al cargar', errLoadRanking:'Error al cargar ranking', errLoadFeed:'Error al cargar feed.',
    noActivityYet:'Sin actividad aún.', noActivityFirst:'Sin actividad aún.<br>¡Sé el primero! 💪',
    noMsgsYet:'Sin mensajes aún.', noMsgsFirst:'¡Sin mensajes aún. Sé el primero! 💬',
    calculating:'Calculando...', weightNoData:'¡Registra tu peso en los check-ins para ver la evolución aquí!',
    weightSetGoal:'¡Define una meta de peso para seguir tu progreso!', monthlyPts:'pts mensuales',
    activeToday:'Activos hoy', filterAll:'Todos', filterActive:'✅ Activos', filterPending:'⏳ Pendientes',
    filterBlocked:'🚫 Bloqueados', filterInactive:'😴 Inactivos',
    fixHallBtn:'🏆 Corregir Hall', tiebreakBtn:'🔢 Desempate', fixHallOfFame:'🏆 Corregir Hall of Fame',
    rankOrder:'🔢 Orden del Ranking', rankOrderHelp:'Usa ▲▼ para reordenar en caso de empate',
    firstPlace:'🥇 1° Lugar', secondPlace:'🥈 2° Lugar', thirdPlace:'🥉 3° Lugar',
    ...
    accessBlocked:'Acceso bloqueado', weightRegister:'¡Registra tu peso para ver la evolución aquí!',
  }
};
